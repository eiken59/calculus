...
\begin{center}
    \includegraphics[width=0.45\textwidth]{number_line.PNG}\figtag{1.1.1}
\end{center}
...
\begin{center}
    \includegraphics[width=0.6\textwidth]{number_line_example.JPG}\figtag{1.1.2}
\end{center}
...
\begin{center}
    \includegraphics[width=0.55\textwidth]{jumpy.png}\figtag{2.1.2}
\end{center}
...
\begin{enumerate}[label=\arabic*.]
    ...
    \begin{multicols}{2}
        \begin{enumerate}
            ...
            \item $c=4$.\\
            \includegraphics[width=0.37\textwidth]{limit_ex_4.png}
            \item $c=-2$.\\
            \includegraphics[width=0.37\textwidth]{limit_ex_5.png}
            \item $c=1$.\\
            \includegraphics[width=0.37\textwidth]{limit_ex_6.png}
        \end{enumerate}
    \end{multicols}
    ...
    \begin{enumerate}
        ...
        \end{multicols}
        \item $\displaystyle\lim_{x\to 0}f(x)$ with $f(x)=\left\{\begin{array}{ll}
            1, \quad & \text{if $x\ne0$},\\
            3, \quad & \text{if $x=0$}.
        \end{array}\right.$
        \item $\displaystyle\lim_{x\to 1}f(x)$ with $f(x)=\left\{\begin{array}{ll}
            3x, \quad & \text{if $x<1$},\\
            3, \quad & \text{if $x>1$}.
        \end{array}\right.$
        \item $\displaystyle\lim_{x\to 4}f(x)$ with $f(x)=\left\{\begin{array}{ll}
            x^2, \quad & \text{if $x\ne4$},\\
            0, \quad & \text{if $x=4$}.
        \end{array}\right.$
        \item $\displaystyle\lim_{x\to 0}f(x)$ with $f(x)=\left\{\begin{array}{ll}
...
\begin{enumerate}[label=\arabic*.]
    ...
    \begin{enumerate}
        \begin{multicols}{4}
            ...
            \item $\displaystyle\lim_{x\to 0}\dfrac{x}{|x|}$.
        \end{multicols}
        \item $\displaystyle\lim_{x\to 2^+}f(x)$ with $f(x)=\left\{\begin{array}{ll}
