...
\begin{center}
    \includegraphics[width=0.3\textwidth]{unit_circle_rotation.JPG}\figtag{1.4.3}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\textwidth]{unit_circle_inverse_rot.JPG}\figtag{1.4.4}
\end{center}
...
The limit is not relavent whether the function is defined at $c$ or not. Limit is just about how the function behaves near $c$ and not at $c$. Take a look as the three cases in Figure 2.1.1. 
...
\begin{center}
    \includegraphics[width=0.7\textwidth/3]{unbounded_limits.JPG}\figtag{2.1.3}
\end{center}
